...
@Preview(name = "SearchRadiusCard – Dark", showBackground = true, backgroundColor = 0xFF131313, widthDp = 300)
@Composable
private fun SearchRadiusCardDarkPreview() {
    var radius by remember { mutableFloatStateOf(5f) }
    LocalMarkTheme(darkTheme = true) {
        Box(modifier = Modifier.padding(16.dp)) {
            SearchRadiusCard(radiusKm = radius, onRadiusChange = { radius = it })
        }
    }
}

@Preview(name = "SearchRadiusCard – Light", showBackground = true, backgroundColor = 0xFFF7F9FB, widthDp = 300)
@Composable
private fun SearchRadiusCardLightPreview() {
    var radius by remember { mutableFloatStateOf(2.5f) }
