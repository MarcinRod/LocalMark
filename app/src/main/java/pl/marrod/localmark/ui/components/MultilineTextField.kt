...
@Preview(
    name = "MultilineTextField – Empty (Dark)",
    showBackground = true,
    backgroundColor = 0xFF131313
)
@Composable
private fun MultilineTextFieldEmptyDarkPreview() {
...
@Preview(
    name = "MultilineTextField – With text (Dark)",
    showBackground = true,
    backgroundColor = 0xFF131313
)
@Composable
private fun MultilineTextFieldFilledDarkPreview() {
    LocalMarkTheme(darkTheme = true) {
        MultilineTextField(
            value = "Water main break on 5th Ave, huge puddle blocking the right lane neaaaaar the crosswalk. Very long text to test multiline behavior. Please avoid the area if possible, traffic is backed up for blocks. 1234 ",
            onValueChange = {},
            modifier = Modifier.padding(16.dp),
            placeholder =  "What's happening here?",
        )
...
@Preview(
    name = "MultilineTextField – Empty (Light)",
    showBackground = true,
    backgroundColor = 0xFFF7F9FB
)
@Composable
private fun MultilineTextFieldEmptyLightPreview() {
