...
@Preview(name = "SearchBar – Collapsed", showBackground = true, backgroundColor = 0xFF1A1F2E)
@Composable
private fun PlacesSearchBarCollapsedPreview() {
...
@Preview(name = "SearchBar – Expanded empty", showBackground = true, backgroundColor = 0xFF1A1F2E)
@Composable
private fun PlacesSearchBarExpandedEmptyPreview() {
    LocalMarkTheme(darkTheme = true) {
        PlacesSearchBar(
            isExpanded = true,
            query = "",
...
@Preview(
    name = "SearchBar – Expanded with query",
    showBackground = true,
    backgroundColor = 0xFF1A1F2E
)
@Composable
private fun PlacesSearchBarExpandedQueryPreview() {
    LocalMarkTheme(darkTheme = true) {
        PlacesSearchBar(
            isExpanded = true,
            query = "Warsaw city centre",
            onQueryChange = {},
            onToggle = {},
        )
    }
...
@Preview(
    name = "PlaceSearchResultsList – Dark",
    showBackground = true,
    backgroundColor = 0xFF1A1F2E
)
@Composable
private fun PlaceSearchResultsListPreview() {
    LocalMarkTheme(darkTheme = true) {
        PlaceSearchResultsList(
            results = listOf(
                PlaceResult(
                    placeId = "1",
                    primaryText = "Warsaw Central Station",
                    secondaryText = "Warsaw, Poland",
                ),
                PlaceResult(
                    placeId = "2",
                    primaryText = "Old Town Market Square",
                    secondaryText = "Stare Miasto, Warsaw",
                ),
                PlaceResult(
                    placeId = "3",
                    primaryText = "Warsaw Chopin Airport",
                    secondaryText = "Żwirki i Wigury, Warsaw",
                ),
                PlaceResult(
                    placeId = "4",
                    primaryText = "Warsaw Chopin Airport",
...
@Preview(name = "SearchBar + Results – Dark", showBackground = true, backgroundColor = 0xFF1A1F2E)
@Composable
private fun PlacesSearchBarWithResultsPreview() {
    LocalMarkTheme(darkTheme = true) {
        var query by remember { mutableStateOf("Warsaw") }
